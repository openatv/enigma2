...
void setListBoxScrollbarStyle(int,int,int,ePtr<gPixmap>,ePtr<gPixmap>);
%{
void setListBoxScrollbarStyle(int width, int offset, int borderwidth, ePtr<gPixmap> &pixmap, ePtr<gPixmap> &backgroundpixmap)
{
