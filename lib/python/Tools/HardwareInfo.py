...
#			print "using cached result"
	...
	def has_hdmi(self):
		return (HardwareInfo.device_name == 'dm7020hd' or HardwareInfo.device_name == 'dm800se' or HardwareInfo.device_name == 'dm500hd' or HardwareInfo.device_name.startswith('gb') or (HardwareInfo.device_name == 'dm8000' and HardwareInfo.device_version != None))
