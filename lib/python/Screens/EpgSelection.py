	...
	if data.find('xres="1280"') >= 0:
		QuickEPG = """
			<screen name="QuickEPG" position="0,505" size="1280,215" title="QuickEPG" backgroundColor="transparent" flags="wfNoBorder">
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/red.png" position="260,160" size="25,25" alphatest="blend" />
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/green.png" position="450,160" size="25,25" alphatest="blend" />
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/yellow.png" position="640,160" size="25,25" alphatest="blend" />
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/blue.png" position="830,160" size="25,25" alphatest="blend" />
		...
		QuickEPG = """
			<screen name="QuickEPG" position="0,325" size="720,276" title="QuickEPG" backgroundColor="transparent" flags="wfNoBorder" >
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/red.png" position="80,210" size="25,25" alphatest="blend" zPosition="4" />
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/green.png" position="210,210" size="25,25" alphatest="blend" zPosition="4" />
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/yellow.png" position="340,210" size="25,25" alphatest="blend" zPosition="4" />
				...
				<ePixmap pixmap="ViX_Day_HD/buttons/blue.png" position="470,210" size="25,25" alphatest="blend" zPosition="4" />
