...
def getAboutText():
	...
	if getMachineBuild() in ('u41'):
		...
		cpuMHz = "   (1,3 GHz)"
	elif getMachineBuild() in ('gbmv200','u51','u5','u53','u52','u54','u55','u56','u5pvr','h9','h9combo','cc1','sf8008','hd60','hd61','i55plus','ustym4kpro','beyonwizv2','v8plus','multibox'):
		cpuMHz = "   (1,6 GHz)"
	...
	if getMachineBuild() not in ('gbmv200','vuduo4k','v8plus','ustym4kpro','beyonwizv2','hd60','hd61','i55plus','osmio4k','osmio4kplus','h9','h9combo','vuzero4k','sf5008','et13000','et1x000','hd51','hd52','vusolo4k','vuuno4k','vuuno4kse','vuultimo4k','sf4008','dm820','dm7080','dm900','dm920', 'gb7252', 'dags7252', 'vs1500','h7','xc7439','8100s','u5','u5pvr','u52','u53','u54','u55','u56','u51','cc1','sf8008'):
