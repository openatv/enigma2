...
def getAboutText():
	...
	if getMachineBuild() in ('u41'):
		...
		cpuMHz = "   (1,3 GHz)"
	elif getMachineBuild() in ('gbmv200','u51','u5','u53','u52','u54','u55','u56','u5pvr','h9','h9combo','cc1','sf8008','hd60','hd61','i55plus','ustym4kpro','beyonwizv2','viper4k','v8plus','multibox'):
		cpuMHz = "   (1,6 GHz)"
	...
	if getMachineBuild() not in ('gbmv200','vuduo4k','v8plus','ustym4kpro','beyonwizv2','viper4k','hd60','hd61','i55plus','osmio4k','osmio4kplus','h9','h9combo','vuzero4k','sf5008','et13000','et1x000','hd51','hd52','vusolo4k','vuuno4k','vuuno4kse','vuultimo4k','sf4008','dm820','dm7080','dm900','dm920', 'gb7252', 'dags7252', 'vs1500','h7','xc7439','8100s','u5','u5pvr','u52','u53','u54','u55','u56','u51','cc1','sf8008'):
	...
	def createscreen(self):
		...
		if eth0.has_key('addr'):
			if eth0.has_key('ifname'):
				self.AboutText += '{:<38}'.format(_('Interface:')) + "\t" + " /dev/" + eth0['ifname'] + "\n"
			self.AboutText += '{:<38}'.format(_("IP:")) + "\t" + eth0['addr'] + "\n"
			if eth0.has_key('netmask'):
				self.AboutText += '{:<38}'.format(_("Netmask:")) + "\t" + eth0['netmask'] + "\n"
			if eth0.has_key('hwaddr'):
				self.AboutText += '{:<38}'.format(_("MAC:")) + "\t" + eth0['hwaddr'] + "\n"
			self.AboutText += '{:<38}'.format(_("Network Speed:")) + "\t" + netspeed() + "\n"
			self.iface = 'eth0'

		eth1 = about.getIfConfig('eth1')
		if eth1.has_key('addr'):
			if eth1.has_key('ifname'):
				self.AboutText += '{:<38}'.format(_('Interface:')) + "\t" + " /dev/" + eth1['ifname'] + "\n"
			self.AboutText += '{:<38}'.format(_("IP:")) + "\t" + eth1['addr'] + "\n"
			if eth1.has_key('netmask'):
				self.AboutText += '{:<38}'.format(_("Netmask:")) + "\t" + eth1['netmask'] + "\n"
			if eth1.has_key('hwaddr'):
				self.AboutText += '{:<38}'.format(_("MAC:")) + "\t" + eth1['hwaddr'] + "\n"
			self.AboutText += '{:<38}'.format(_("Network Speed:")) + "\t" + netspeed() + "\n"
			self.iface = 'eth1'
		...
		if ra0.has_key('addr'):
			if ra0.has_key('ifname'):
				self.AboutText += '{:<38}'.format(_('Interface:')) + "\t" + " /dev/" + ra0['ifname'] + "\n"
			self.AboutText += '{:<38}'.format(_("IP:")) + "\t" + ra0['addr'] + "\n"
			if ra0.has_key('netmask'):
				self.AboutText += '{:<38}'.format(_("Netmask:")) + "\t" + ra0['netmask'] + "\n"
			if ra0.has_key('hwaddr'):
				self.AboutText += '{:<38}'.format(_("MAC:")) + "\t" + ra0['hwaddr'] + "\n"
			self.AboutText += '{:<38}'.format(_("Network Speed:")) + "\t" + netspeed() + "\n"
			self.iface = 'ra0'
		...
		if wlan0.has_key('addr'):
			if wlan0.has_key('ifname'):
				self.AboutText += '{:<38}'.format(_('Interface:')) + "\t" + " /dev/" + wlan0['ifname'] + "\n"
			self.AboutText += '{:<38}'.format(_("IP:")) + "\t" + wlan0['addr'] + "\n"
			if wlan0.has_key('netmask'):
				self.AboutText += '{:<38}'.format(_("Netmask:")) + "\t" + wlan0['netmask'] + "\n"
			if wlan0.has_key('hwaddr'):
				self.AboutText += '{:<38}'.format(_("MAC:")) + "\t" + wlan0['hwaddr'] + "\n"
			self.AboutText += '{:<38}'.format(_("Network Speed:")) + "\t" + netspeed() + "\n"
			self.iface = 'wlan0'
		...
		if wlan1.has_key('addr'):
			if wlan1.has_key('ifname'):
				self.AboutText += '{:<38}'.format(_('Interface:')) + "\t" + " /dev/" + wlan1['ifname'] + "\n"
			self.AboutText += '{:<38}'.format(_("IP:")) + "\t" + wlan1['addr'] + "\n"
			if wlan1.has_key('netmask'):
				self.AboutText += '{:<38}'.format(_("Netmask:")) + "\t" + wlan1['netmask'] + "\n"
			if wlan1.has_key('hwaddr'):
				self.AboutText += '{:<38}'.format(_("MAC:")) + "\t" + wlan1['hwaddr'] + "\n"
			self.AboutText += '{:<38}'.format(_("Network Speed:")) + "\t" + netspeed() + "\n"
			self.iface = 'wlan1'

		rx_bytes, tx_bytes = about.getIfTransferredData(self.iface)
		self.AboutText += "\n" + '{:<38}'.format(_("Bytes received:")) + "\t" + rx_bytes + "\n"
		self.AboutText += '{:<38}'.format(_("Bytes sent:")) + "\t" + tx_bytes + "\n"

		hostname = file('/proc/sys/kernel/hostname').read()
		self.AboutText += "\n" + '{:<38}'.format(_("Hostname:")) + "\t" + hostname + "\n"
