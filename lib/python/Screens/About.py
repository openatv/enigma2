...
def getAboutText():
	...
	if getMachineBuild() in ('vusolo4k'):
		...
		cpuMHz = "   (1,7 GHz)"
	elif getMachineBuild() in ('et11000','hd52','hd51','sf4008','vs1500'):
		try:
			import binascii
	...
	if getMachineBuild() not in ('et11000','hd51','hd52','vusolo4k','vuuno4k','vuultimo4k','sf4008','dm820','dm7080','dm900', 'gb7252', 'dags7252', 'vs1500'):
