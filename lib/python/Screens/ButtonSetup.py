...
def getButtonSetupKeys():
	return [
		...
		(pgettext("button|label", "ⓘ Info button"), "info", "Infobar/InfoPressed/1"),
		(pgettext("button|label", "ⓘ Info button hold"), "info_long", "Infobar/showEventInfoPlugins/1"),
		...
		(pgettext("button|label", "Channel + button"), "channelup", ""),
		(pgettext("button|label", "Channel - button"), "channeldown", ""),
