...
def getButtonSetupKeys():
	buttonConfig = [
			...
			("Channel Up button", "channelup", ""),
			("Channel Down button", "channeldown", ""),
			...
			("Favourites button", "favorites", ""),
			("Favourites button hold", "favorites_long", ""),
			("File button", "file", ""),
			...
			("││ Pause button", "pause", ""),
			("■ Stop button", "stop", ""),
			("◀︎◀︎ Rewind button", "rewind", ""),
			("▶︎▶︎ Fast Forward button", "fastforward", ""),
			("Skip Backward button", "skip_back", ""),
			("Skip Forward button", "skip_forward", ""),
			("Activate PiP button", "activatePiP", ""),
			...
			("HDMI-in button", "HDMIin", "Infobar/HDMIIn"),
			("HDMI-in button hold", "HDMIin_long", (SystemInfo["LcdLiveTV"] and "Infobar/ToggleLCDLiveTV") or ""),
			("Context button", "contextMenu", "Infobar/showExtensionSelection"),
			("Context button hold", "context_long", ""),
			("SAT button", "sat", "Infobar/openSatellites"),
