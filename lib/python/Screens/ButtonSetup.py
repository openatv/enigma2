...
def getButtonSetupFunctions():
	...
	ButtonSetupFunctions.append((_("Show audio selection"), "Infobar/audioSelection", "InfoBar"))
	...
	ButtonSetupFunctions.append((_("Language selection"), "Module/Screens.LanguageSelection/LanguageSelection", "Setup"))
