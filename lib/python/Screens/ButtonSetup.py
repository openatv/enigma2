...
def getButtonSetupKeys():
	return [
		(pgettext("button|label", "Red button"), "red", ""),
		(pgettext("button|label", "Red button hold"), "red_long", ""),
		(pgettext("button|label", "Green button"), "green", ""),
		(pgettext("button|label", "Green button hold"), "green_long", ""),
		(pgettext("button|label", "Yellow button"), "yellow", ""),
		(pgettext("button|label", "Yellow button hold"), "yellow_long", ""),
		(pgettext("button|label", "Blue button"), "blue", ""),
		(pgettext("button|label", "Blue button hold"), "blue_long", ""),
		(pgettext("button|label", "Info/EPG button"), "info", "Infobar/InfoPressed/1"),
		(pgettext("button|label", "Info/EPG button hold"), "info_long", "Infobar/showEventInfoPlugins/1"),
		(pgettext("button|label", "EPG/Guide button"), "epg", "Infobar/EPGPressed/1"),
		(pgettext("button|label", "EPG/Guide button hold"), "epg_long", "Infobar/showEventGuidePlugins/1"),
		(pgettext("button|label", "◀︎ Left button"), "cross_left", ""),
		(pgettext("button|label", "◀︎ Left button hold"), "cross_left_long", ""),
		(pgettext("button|label", "Right ▶︎ button"), "cross_right", ""),
		(pgettext("button|label", "Right ▶︎ button hold"), "cross_right_long", "Infobar/seekFwdVod"),
		(pgettext("button|label", "▲ Up button"), "cross_up", ""),
		(pgettext("button|label", "▼ Down button"), "cross_down", ""),
		(pgettext("button|label", "Page Up button"), "pageup", ""),
		(pgettext("button|label", "Page Up button hold"), "pageup_long", ""),
		(pgettext("button|label", "Page Down button"), "pagedown", ""),
		(pgettext("button|label", "Page Down button hold"), "pagedown_long", ""),
		(pgettext("button|label", "Channel Up button"), "channelup", ""),
		(pgettext("button|label", "Channel Down button"), "channeldown", ""),
		(pgettext("button|label", "Eject button"), "ejectcd", ""),
		(pgettext("button|label", "Eject button hold"), "ejectcd_long", ""),
		(pgettext("button|label", "TV button"), "showTv", ""),
		(pgettext("button|label", "Radio button"), "radio", ""),
		(pgettext("button|label", "Radio button hold"), "radio_long", ""),
		(pgettext("button|label", "● REC button"), "rec", ""),
		(pgettext("button|label", "● REC button hold"), "rec_long", ""),
		(pgettext("button|label", "Text button"), "text", ""),
		(pgettext("button|label", "Help button"), "displayHelp", ""),
		(pgettext("button|label", "Help button hold"), "displayHelp_long", ""),
		(pgettext("button|label", "Subtitle button"), "subtitle", ""),
		(pgettext("button|label", "Subtitle button hold"), "subtitle_long", ""),
		(pgettext("button|label", "Menu button"), "mainMenu", ""),
		(pgettext("button|label", "List/FAV button"), "list", ""),
		(pgettext("button|label", "List/FAV button hold"), "list_long", ""),
		(pgettext("button|label", "PVR button"), "pvr", ""),
		(pgettext("button|label", "PVR button hold"), "pvr_long", ""),
		(pgettext("button|label", "Favourites button"), "favorites", ""),
		(pgettext("button|label", "Favourites button hold"), "favorites_long", ""),
		(pgettext("button|label", "File button"), "file", ""),
		(pgettext("button|label", "File button hold"), "file_long", ""),
		(pgettext("button|label", "OK button hold"), "ok_long", ""),
		(pgettext("button|label", "Media button"), "media", ""),
		(pgettext("button|label", "Media button hold"), "media_long", ""),
		(pgettext("button|label", "Open button"), "open", ""),
		(pgettext("button|label", "Open button hold"), "open_long", ""),
		(pgettext("button|label", "Option button"), "option", ""),
		(pgettext("button|label", "Option button hold"), "option_long", ""),
		(pgettext("button|label", "www button"), "www", ""),
		(pgettext("button|label", "www button hold"), "www_long", ""),
		(pgettext("button|label", "Directory button"), "directory", ""),
		(pgettext("button|label", "Directory button hold"), "directory_long", ""),
		(pgettext("button|label", "Back/Recall button"), "back", ""),
		(pgettext("button|label", "Back/Recall button hold"), "back_long", ""),
		(pgettext("button|label", "History button"), "archive", ""),
		(pgettext("button|label", "History button hold"), "archive_long", ""),
		(pgettext("button|label", "Aspect button"), "mode", ""),
		(pgettext("button|label", "Aspect button hold"), "mode_long", ""),
		(pgettext("button|label", "Home button"), "home", ""),
		(pgettext("button|label", "Home button hold"), "home_long", ""),
		(pgettext("button|label", "End button"), "end", ""),
		(pgettext("button|label", "End button hold"), "end_long", ""),
		(pgettext("button|label", "Next button"), "next", ""),
		(pgettext("button|label", "Previous button"), "previous", ""),
		(pgettext("button|label", "Audio button"), "audio", ""),
		(pgettext("button|label", "Audio button hold"), "audio_long", ""),
		(pgettext("button|label", "▶︎ Play button"), "play", ""),
		(pgettext("button|label", "▶︎││ Play/Pause button"), "playpause", ""),
		(pgettext("button|label", "││ Pause button"), "pause", ""),
		(pgettext("button|label", "■ Stop button"), "stop", ""),
		(pgettext("button|label", "◀︎◀︎ Rewind button"), "rewind", ""),
		(pgettext("button|label", "▶︎▶︎ Fast Forward button"), "fastforward", ""),
		(pgettext("button|label", "Skip Backward button"), "skip_back", ""),
		(pgettext("button|label", "Skip Forward button"), "skip_forward", ""),
		(pgettext("button|label", "Activate PiP button"), "activatePiP", ""),
		(pgettext("button|label", "Playlist button"), "playlist", ""),
		(pgettext("button|label", "Playlist button hold"), "playlist_long", ""),
		(pgettext("button|label", "Next Track ▶︎▶︎│ button"), "nextsong", ""),
		(pgettext("button|label", "Next Track ▶︎▶︎│ button hold"), "nextsong_long", ""),
		(pgettext("button|label", "│◀︎◀︎ Previous Track button"), "prevsong", ""),
		(pgettext("button|label", "│◀︎◀︎ Previous Track button hold"), "prevsong_long", ""),
		(pgettext("button|label", "Program button"), "prog", ""),
		(pgettext("button|label", "Program button hold"), "prog_long", ""),
		(pgettext("button|label", "Time button"), "time", ""),
		(pgettext("button|label", "Time button hold"), "time_long", ""),
		(pgettext("button|label", "Homepage button"), "homep", ""),
		(pgettext("button|label", "Homepage button hold"), "homep_long", ""),
		(pgettext("button|label", "Search/WEB button"), "search", ""),
		(pgettext("button|label", "Search/WEB button hold"), "search_long", ""),
		(pgettext("button|label", "│▶︎ Slow button"), "slow", ""),
		(pgettext("button|label", "Mark/Portal/Playlist button"), "mark", ""),
		(pgettext("button|label", "Mark/Portal/Playlist button hold"), "mark_long", ""),
		(pgettext("button|label", "Sleep button"), "sleep", ""),
		(pgettext("button|label", "Sleep button hold"), "sleep_long", ""),
		(pgettext("button|label", "Power button"), "power", ""),
		(pgettext("button|label", "Power button hold"), "power_long", ""),
		(pgettext("button|label", "HDMI-in button"), "HDMIin", "Infobar/HDMIIn"),
		(pgettext("button|label", "HDMI-in button hold"), "HDMIin_long", (SystemInfo["LcdLiveTV"] and "Infobar/ToggleLCDLiveTV") or ""),
		(pgettext("button|label", "Context button"), "contextMenu", "Infobar/showExtensionSelection"),
		(pgettext("button|label", "Context button hold"), "context_long", ""),
		(pgettext("button|label", "SAT button"), "sat", "Infobar/openSatellites"),
		(pgettext("button|label", "SAT button hold"), "sat_long", ""),
		(pgettext("button|label", "Prov button"), "prov", ""),
		(pgettext("button|label", "Prov button hold"), "prov_long", ""),
		(pgettext("button|label", "LAN button"), "lan", ""),
		(pgettext("button|label", "LAN button hold"), "lan_long", ""),
		(pgettext("button|label", "PC button"), "pc", ""),
		(pgettext("button|label", "PC button hold"), "pc_long", ""),
		(pgettext("button|label", "F1 button"), "f1", ""),
		(pgettext("button|label", "F1 button hold"), "f1_long", ""),
		(pgettext("button|label", "F2 button"), "f2", ""),
		(pgettext("button|label", "F2 button hold"), "f2_long", ""),
		(pgettext("button|label", "F3 button"), "f3", ""),
		(pgettext("button|label", "F3 button hold"), "f3_long", ""),
		(pgettext("button|label", "F4 button"), "f4", ""),
		(pgettext("button|label", "F4 button hold"), "f4_long", ""),
		(pgettext("button|label", "PiP button"), "f6", ""),
		(pgettext("button|label", "PiP button hold"), "f6_long", ""),
		(pgettext("button|label", "Mouse button"), "mouse", ""),
		(pgettext("button|label", "Mouse button hold"), "mouse_long", ""),
		(pgettext("button|label", "VOD/IPTV button"), "vod", ""),
		(pgettext("button|label", "VOD/IPTV button hold"), "vod_long", ""),
		(pgettext("button|label", "Keyboard button"), "keyboard", ""),
		(pgettext("button|label", "Keyboard button hold"), "keyboard_long", ""),
		(pgettext("button|label", "Zoom button"), "zoom", ""),
		(pgettext("button|label", "Zoom button hold"), "zoom_long", ""),
	]
