	...
	def setLang(self):
		if self.lang == 'de_DE':
			...
			self.shiftkeys_list = [
				...
				[u"SHIFT", u"SPACE", u"Ā", u"Č", u"Ē", u"Ģ", u"Ī", u"Ķ", u"Ļ", u"Ņ", u"LEFT", u"RIGHT"]]
			self.nextLang = 'uk_UK'
		elif self.lang == 'uk_UK':
			self.keys_list = [
				[u"EXIT", u"1", u"2", u"3", u"4", u"5", u"6", u"7", u"8", u"9", u"0", u"BACKSPACE"],
				[u"й", u"ц", u"у", u"к", u"е", u"н", u"г", u"ш", u"щ", u"з", u"х", u"ї"],
				[u"ф", u"і", u"в", u"а", u"п", u"р", u"о", u"л", u"д", u"ж", u"є", u"#"],
				[u"<", u"я", u"ч", u"с", u"м", u"и", u"т", u"ь", u"б", u"ю", u"-", u"ALL"],
				[u"SHIFT", u"SPACE", u"@", u",", u".", u"+", u"OK", u"LEFT", u"RIGHT"]]
			self.shiftkeys_list = [
				[u"EXIT", u"!", u'"', u"§", u"$", u"%", u"&", u"/", u"(", u")", u"=", u"BACKSPACE"],
				[u"Й", u"Ц", u"У", u"К", u"Е", u"Н", u"Г", u"Ш", u"Щ", u"З", u"Х", u"Ї"],
				[u"Ф", u"І", u"В", u"А", u"П", u"Р", u"О", u"Л", u"Д", u"Ж", u"Є", u"'"],
				[u">", u"Я", u"Ч", u"С", u"М", u"И", u"Т", u"Ь", u"Б", u"Ю", u"_", u"CLEAR"],
