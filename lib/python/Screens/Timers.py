...
POWERTIMER_VALUES = {POWERTIMER_TYPES[x]: x for x in POWERTIMER_TYPES.keys()}
...
POWERTIMER_AFTER_VALUES = {POWERTIMER_AFTER_EVENTS[x]: x for x in POWERTIMER_AFTER_EVENTS.keys()}
...
RECORDTIMER_VALUES = {RECORDTIMER_TYPES[x]: x for x in RECORDTIMER_TYPES.keys()}
...
RECORDTIMER_AFTER_VALUES = {RECORDTIMER_AFTER_EVENTS[x]: x for x in RECORDTIMER_AFTER_EVENTS.keys()}
