...
class IniTerrestrialLocation(Screen):
	...
	<screen name="IniTerrestrialLocation" position="center,center" size="560,550">
		...
		<widget name="description" conditional="description" position="0,e-75" size="560,75" font="Regular;18" halign="center" valign="top" transparent="0" zPosition="1" />
		<widget name="text" conditional="text" position="0,e-75" size="560,75" font="Regular;18" halign="center" valign="top" transparent="0" zPosition="1" />
	</screen>"""
	...
	def __init__(self, session):
		...
		self[description_widget] = Label(_("Please select your location and then press OK to begin the scan.\n\nIf your location is not listed or the scan fails to find all channels, please select Full Scan."))
