...
#	hotkeyFunctions.append((_("Switch channel down"), "Infobar/switchChannelUp", "InfoBar"))
#	hotkeyFunctions.append((_("Switch channel up"), "Infobar/switchChannelDown", "InfoBar"))
