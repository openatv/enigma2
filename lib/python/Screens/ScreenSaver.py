	...
	def __init__(self, session):
		...
		self.skin = """
			<screen name="Screensaver" position="fill" flags="wfNoBorder">
				...
				<widget name="picture" pixmap="skin_default/gb-screensaver.png" position="0,0" size="256,243" alphatest="blend" backgroundColor="secondBG" transparent="1" zPosition="1"/>
			</screen>"""
