...
from Tools.Directories import fileExists, pathExists, resolveFilename, SCOPE_CONFIG, SCOPE_PLAYLIST, SCOPE_ACTIVE_SKIN, SCOPE_CURRENT_SKIN
...
class MediaPixmap(Pixmap):
	...
	def onShow(self):
		...
		self.picload.setPara((self.instance.size().width(), self.instance.size().height(), sc[0], sc[1], False, 1, "#FF000000"))
