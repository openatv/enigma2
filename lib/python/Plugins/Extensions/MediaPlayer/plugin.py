...
def Plugins(**kwargs):
	return [
		PluginDescriptor(name = _("MediaPlayer"), description = "Play back media files", where = PluginDescriptor.WHERE_MENU, needsRestart = False, fnc = menu),
		PluginDescriptor(name = _("MediaPlayer"), where = PluginDescriptor.WHERE_FILESCAN, needsRestart = False, fnc = filescan),
	]
