...
class Project:
	...
	def __init__(self):
		...
		self.settings.authormode = ConfigSelection(choices=[("menu_linked", _("Linked titles with a DVD menu")), ("just_linked", _("Direct playback of linked titles without menu")), ("menu_seperate", _("Seperate titles with a main menu")), ("bdmv", _("BDMV Compatible Blue-ray disk (HDTV only)")), ("data_ts", _("Dreambox format data DVD (HDTV compatible)"))])
