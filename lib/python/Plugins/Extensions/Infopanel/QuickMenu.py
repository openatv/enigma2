...
######## Software Manager Menu ##############################
	def Qsoftware(self):
		...
		if not getBoxType().startswith('az') and not getBoxType().startswith('dm') and not getBrandOEM().startswith('cube') and not getBoxType() in ('hd51'):
		...
		if not getBoxType().startswith('az') and not getBrandOEM().startswith('cube') and not getBrandOEM().startswith('wetek') and not getBoxType() in ('hd51'):
