...
def main(session, **kwargs):
	...
	#session.openWithCallback(test, ChoiceBox, title="Delete everything on this STB-BOX?", list=[(_("yes"), "yes"), (_("no"), "no"), (_("perhaps"), "perhaps"), (_("ask me tomorrow"), "ask me tomorrow"), (_("leave me alone with this!"), "yes")])
