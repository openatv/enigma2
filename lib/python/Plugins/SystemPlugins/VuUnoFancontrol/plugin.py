...
class ManualFancontrol(Screen,ConfigListScreen):
	skin = """
			...
			<ePixmap pixmap="skin_default/buttons/red.png" position="10,10" size="25,25" alphatest="blend" />
			<ePixmap pixmap="skin_default/buttons/green.png" position="290,10" size="25,25" alphatest="blend" />
