...
class FPGAUpgrade(Screen):
	skin = 	"""
		<screen position="center,center" size="560,440" title="FPGA Upgrade" >
			<ePixmap pixmap="DMConcinnity-HD/buttons/red.png" position="0,7" size="140,40" alphatest="blend" />
			<ePixmap pixmap="DMConcinnity-HD/buttons/green.png" position="140,7" size="140,40" alphatest="blend" />
			<ePixmap pixmap="DMConcinnity-HD/buttons/yellow.png" position="280,7" size="140,40" alphatest="blend" />
			<ePixmap pixmap="DMConcinnity-HD/buttons/blue.png" position="420,7" size="140,40" alphatest="blend" />
