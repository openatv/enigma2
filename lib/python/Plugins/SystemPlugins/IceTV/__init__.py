...
def getIceTVDeviceType():
    return {
        ...
        ("Beyonwiz", "U4"): 36,
        ("Beyonwiz", "V2"): 38,
    }.get((BoxInfo.getItem("displaybrand"), BoxInfo.getItem("displaymodel")), 39)
...
config.plugins.icetv.device.label = ConfigText(default="%s %s" % (BoxInfo.getItem("displaybrand"), BoxInfo.getItem("displaymodel")))
