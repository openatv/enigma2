...
HaveGZkernel = True
if getMachineBuild() in ('dags72604', 'u51','u52','u53','h9','vuzero4k','u5','u5pvr','sf5008','et13000','et1x000',"vuuno4k","vuuno4kse", "vuultimo4k", "vusolo4k", "spark", "spark7162", "hd51", "hd52", "sf4008", "dags7252", "gb7252", "vs1500","h7",'xc7439','8100s'):
	HaveGZkernel = False
...
class ImageBackup(Screen):
	...
	def doFullBackup(self, DIRECTORY):
		...
		cmdlist.append("sync")
		if ( SystemInfo["HaveMultiBoot"] and getMachineBuild() not in ("gb7252")]) and self.list[self.selection] == "Recovery":
			BLOCK_SIZE=512
			BLOCK_SECTOR=2
