...
class FlashOnline(Screen):
	...
	def list_files(self, PATH):
		...
		if SystemInfo["HaveMultiBoot"]:
			path = PATH
			if getMachineBuild() in ("gbmv200","ustym4kpro","hd51","vs1500","h7","8100s","gb7252","cc1","sf8008","osmio4k","osmio4kplus","beyonwizv2"):
	...
	def Start_Flashing(self):
		...
		if os.path.exists(ofgwritePath):
			...
			if self.simulate:
				...
				elif getMachineBuild() in ("gbmv200","h9combo","u51","u52","u53","u54","u56","u5","u5pvr","cc1","sf8008","ustym4kpro","beyonwizv2","hd60","hd61","v8plus","multibox"):
