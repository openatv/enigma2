...
def Plugins(path, **kwargs):
	...
	plugin_path = path
	list = [
		PluginDescriptor(name=_("Software management"), description=_("Manage your STB_BOX's software"), where = PluginDescriptor.WHERE_PLUGINMENU, needsRestart = False, fnc=UpgradeMain),
