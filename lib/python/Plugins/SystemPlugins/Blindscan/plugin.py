...
class Blindscan(ConfigListScreen, Screen):
	skin="""
		<screen name="Blindscan" position="center,center" size="560,290" title="Blindscan">
			<ePixmap pixmap="DMConcinnity-HD/buttons/red.png" position="5,0" size="140,40" alphatest="on" />
			<ePixmap pixmap="DMConcinnity-HD/buttons/green.png" position="145,0" size="140,40" alphatest="on" />
			<ePixmap pixmap="DMConcinnity-HD/buttons/button_off.png" position="285,0" size="140,40" alphatest="on" />
			<ePixmap pixmap="DMConcinnity-HD/buttons/blue.png" position="425,0" size="140,40" alphatest="on" />
