...
class ClockToText(Converter, object):
	TIME_OPTIONS = {
		...
		#
		"AsLength": lambda t: "" if t < 0 else "%d:%02d" % (old_div(t, 60), t % 60),
		"AsLengthHours": lambda t: "" if t < 0 else "%d:%02d" % (old_div(t, 3600), old_div(t, 60) % 60),
		"AsLengthSeconds": lambda t: "" if t < 0 else "%d:%02d:%02d" % (old_div(t, 3600), old_div(t, 60) % 60, t % 60),
		...
		#
		"InMinutes": lambda t: ngettext("%d Min", "%d Mins", (old_div(t, 60))) % (old_div(t, 60)),
