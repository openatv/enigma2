...
def InitUsageConfig():
	...
	config.seek.withjumps_forwards_ms  = ConfigSelection([("2000", _("2s")), ("2500", _("2.5s")), ("3000", _("3s")), ("3500", _("3.5s")), ("4000", _("4s")), ("5000", _("5s"))], default="4000")
	config.seek.withjumps_backwards_ms = ConfigSelection([("500", _("0.5s")), ("600", _("0.6s")), ("700", _("0.7s")), ("800", _("0.8s")), ("900", _("0.9s")), ("1000", _("1s")), ("1200", _("1.2s")), ("1500", _("1.5s")), ("2000", _("2s")), ("2500", _("2.5s"))], default="2000")
