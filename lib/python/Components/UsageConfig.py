...
def InitUsageConfig():
	...
	config.usage.serviceitems_per_page = ConfigSlider(default = 16, increment = 1, limits=(3, 20))
	...
	config.epgselction.servicefontsize_vixepg = ConfigSlider(default = 22, increment = 1, limits=(16, 30))
	config.epgselction.eventfontsize_vixepg = ConfigSlider(default = 18, increment = 1, limits=(16, 30))
	...
	config.epgselction.itemsperpage_vixepg = ConfigSlider(default = 11, increment = 1, limits=(3, 16))
