...
def InitUsageConfig():
	...
	config.epgselction.UsePicon = ConfigYesNo(default = True)
	...
	config.epgselction.eventfontsize = ConfigSlider(default = 18, increment = 1, limits=(10, 30))
	config.epgselction.servicefontsize = ConfigSlider(default = 22, increment = 1, limits=(10, 30))
	config.epgselction.Timeline = ConfigSlider(default = 20, increment = 1, limits=(10, 30))
	config.epgselction.items_per_page = ConfigSlider(default = 11, increment = 1, limits=(3, 16))
	...
	config.epgselction.PIG = ConfigYesNo(default = False)
	config.epgselction.item_hight = NoSave(ConfigInteger(default=0))
	config.epgselction.item_width = NoSave(ConfigInteger(default=0))
	config.epgselction.item_rowhight = NoSave(ConfigInteger(default=0))
