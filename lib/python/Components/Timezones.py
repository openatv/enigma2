...
def InitTimeZones():
	...
	config.timezone.area = ConfigSelection(default = "Australia", choices = timezones.getTimezoneAreaList())
	...
	def getTimezoneDefault(self, area=None, choices=None):
		if area == None:
			try:
				...
				print "[Timezones] getTimezoneDefault, no area found, using Australia"
				area = "Australia"
		if choices == None:
