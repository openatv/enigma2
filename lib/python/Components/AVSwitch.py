...
class AVSwitch:
	...
	if (about.getChipSetString() in ('7241', '7358', '7362', '7356', '7424', '7425', 'pnx8493', '7162', '7111'))  or (hw_type in ('elite', 'premium', 'premium+', 'ultra', "me", "minime")):
