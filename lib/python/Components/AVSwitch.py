...
class AVSwitch:
	...
	if modes.has_key("YPbPr") and getBoxType() in ('dm500hdv2','dm500hd','dm800','e3hd','ebox7358','eboxlumi','ebox5100','enfinity','et4x00','iqonios300hd','ixusszero','mbtwinplus','odimm7','optimussos1','osmini','tm2t','tmnano','tmnano2super','tmnano3t','tmnanose','tmnanosecombo','tmsingle','optimussos1','uniboxhd1','vusolo2','vusolo4k','xp1000','mutant51'):
		del modes["YPbPr"]
		
	# Machines that have composite video (yellow RCA socket) but do not have Scart.
	if modes.has_key("Scart") and getBoxType() in ('gb800ueplus','mbtwinplus','osmini','tmnano','tmnano2super','tmnano3t','tmnanosecombo','xpeedlx3'):
