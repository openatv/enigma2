...
def getCPUSpeedString():
	if getMachineBuild() in ('u41','u42','u43','u45'):
		...
		return "1,3 GHz"
	elif getMachineBuild() in ('dagsmv200','gbmv200','u51','u52','u53','u532','u533','u54','u55','u56','u57','u5','u5pvr','h9','i55se','h9se','h9combo','h9combose','h10','cc1','sf8008','sf8008m','hd60','hd61','pulse4k','i55plus','ustym4kpro','beyonwizv2','viper4k','multibox','multiboxse'):
		return "1,6 GHz"
