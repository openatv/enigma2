...
def getCPUSpeedString():
	if getMachineBuild() in ('vusolo4k','vuultimo4k'):
		...
		return "1,7 GHz"
	elif getMachineBuild() in ('hd51','hd52','sf4008','vs1500','et1x000'):
		try:
			import binascii
...
def getCPUString():
	if getMachineBuild() in ('vuuno4k', 'vuultimo4k','vusolo4k', 'hd51', 'hd52', 'sf4008', 'dm900', 'gb7252', 'dags7252', 'vs1500', 'et1x000', 'xc7439'):
		return "Broadcom"
	else:
		try:
			system="unknown"
