	...
	def Recording(self):
		if fileExists("/proc/stb/lcd/symbol_circle"):
			...
			if recordings > 0:
				...
				open("/proc/stb/lcd/symbol_rec", "w").write("0")
		elif getMachineBuild() in ('sf8008', 'sf8008m', 'sf8008ta', 'cc1', 'ustym4kpro', 'beyonwizv2', 'viper4k', 'dagsmv200') and fileExists("/proc/stb/fp/ledpowercolor"):
