...
BoxInfo.setItem("SuspendPowerLed", fileExists("/proc/stb/power/suspendled") and MACHINEBUILD not in ("maxytecmulti", "maxytecmultise", "anadolmulti", "anadolmultitwin", "anadolmultiboxse", "axmulticombo", "axmultitwin", "axmultiboxse", "novaler4k", "novaler4kse"))
