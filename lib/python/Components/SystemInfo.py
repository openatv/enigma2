...
SystemInfo["VFD_scroll_repeats"] = not getBoxType() in ('et8500') and fileCheck("/proc/stb/lcd/scroll_repeats")
SystemInfo["VFD_scroll_delay"] = not getBoxType() in ('et8500') and fileCheck("/proc/stb/lcd/scroll_delay")
SystemInfo["VFD_initial_scroll_delay"] = not getBoxType() in ('et8500') and fileCheck("/proc/stb/lcd/initial_scroll_delay")
SystemInfo["VFD_final_scroll_delay"] = not getBoxType() in ('et8500') and fileCheck("/proc/stb/lcd/final_scroll_delay")
