...
SystemInfo["HaveMultiBoot"] = getMachineBuild() in ('hd51', 'h7', 'vs1500', '8100s') and (1, 4) or getBoxType() in ('gbue4k', 'gbquad4k') and (3, 3) or fileCheck("/boot/cmdline.txt") and (1, 4)
SystemInfo["HaveMultiBootHD"] = getMachineBuild() in ('hd51', 'h7', 'vs1500') and ('440M@328M brcm_cma=192M@768M', '520M@248M brcm_cma=200M@768M')
