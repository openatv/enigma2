...
def InitLcd():
	if getBoxType() in ('gb800se', 'gb800solo', 'iqonios300hd', 'tmsingle', 'tmnano2super', 'tmnanose', 'tmnanoseplus, 'tmnanosem2', 'tmnanosem2plus', 'tmnanosecombo', 'vusolo', 'vusolose', 'vuzero', 'et4x00', 'et5x00', 'et6x00', 'sf8'):
		detected = False
	else:
