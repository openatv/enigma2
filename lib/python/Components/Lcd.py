	...
	if detected:
		...
		if can_lcdmodechecking:
			...
			config.lcd.modepip = ConfigSelection(choices={
					...
					"7": _("PIP with OSD")},
					default = "0")
			if config.misc.boxtype.value in ( 'gbquad', 'gbquadplus', 'gbuhdquad'):
