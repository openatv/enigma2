...
def InitLcd():
	if getBoxType() == 'gb800se' or getBoxType() == 'gb800solo' or getBoxType() == 'gb800ue' or getBoxType() == 'tmsingle' or getBoxType() == 'vusolo' or getBoxType() == 'et5x00' or getBoxType() == 'et6x00':
		detected = False
	else:
