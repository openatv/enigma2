...
{
	bool subcentered = eConfigManager::getConfigBoolValue("config.subtitles.dvb_subtitles_centered") && object->object_horizontal_position * 2 + len < 98 * region->width / 100;
