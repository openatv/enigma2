...
#ifndef __lib_service_dabpaddecoder_h
#define __lib_service_dabpaddecoder_h
...
private:
	...
	uint64_t mot_segments;
	uint64_t mot_data_groups;
...
public:
	...
	uint64_t GetMOTSegments() const {return mot_segments;}
	uint64_t GetMOTDataGroups() const {return mot_data_groups;}
...
#endif /* __lib_service_dabpaddecoder_h */
