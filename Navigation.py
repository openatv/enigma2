...
if path.isfile("/usr/lib/enigma2/python/gbipbox.so"):
	isGBIPBOX = True
	print "[NAVIGATION] isGBIPBOX = True"
...
class Navigation:
	def __init__(self, nextRecordTimerAfterEventActionAuto=False, nextPowerManagerAfterEventActionAuto=False):
		...
		thisBox = getBoxType()
		if thisBox in ('gbquad', 'ixussone', 'uniboxhd1', 'uniboxhd2', 'uniboxhd3', 'sezam5000hd', 'mbtwin', 'beyonwizt3') or getBrandOEM() in ('ebox', 'azbox', 'xp', 'ini'):
